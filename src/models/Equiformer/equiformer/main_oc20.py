...
import models.Equiformer.equiformer.oc20.trainer
import models.Equiformer.equiformer.oc20.trainer.dist_setup 
...
class Runner(submitit.helpers.Checkpointable):
    ...
    def __call__(self, config):
        ...
        if args.distributed:
            ...
            models.Equiformer.equiformer.oc20.trainer.dist_setup.setup(config)
